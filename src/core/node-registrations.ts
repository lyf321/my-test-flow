...
import TwoDDescriptionNode from '@/components/vueflow/nodes/TwoDDescriptionNode.vue'
...
export function registerBuiltInNodes() {
  ...
  // 2D描述节点
  const twoDDescriptionNodeDef: NodeDefinition = {
    type: NodeType.TwoDDescription,
    name: '2D画面描述',
    description: '描述场景的2D画面信息',
    icon: '🎨',
    category: 'business',
    component: TwoDDescriptionNode,
  ...
  nodeRegistry.registerNodeType(twoDDescriptionNodeDef)
}
