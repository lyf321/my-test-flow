<template>
  <div class="condition-node" :class="{ selected: isSelected }">
    <Handle type="target" position="top" :style="{ background: '#4d53e8' }" />
    <Handle type="source" position="bottom" :style="{ background: '#4d53e8' }" />
...
.condition-node.selected {
  border-color: #37d0ff;
  box-shadow: 0 0 0 2px rgba(55, 208, 255, 0.2);
}
